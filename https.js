...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
 ${chalk.white('Engine :')} ${chalk.green.bold('HTTP/2 RAPIDREST STREAM (CVE-2023-44487)')} | Updated : ${chalk.magenta.bold('20/12/2025')}
 ${chalk.white('Contact :')} ${chalk.cyanBright.bold('t.me/vladimir_cnc1')}
